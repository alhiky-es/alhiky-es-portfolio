...
var cards = [
  {
    title: "Profile",
    width: 310,
    html: `<div class="profile-image"><img src="${imagePath}/selfie.jpg" alt="Bryan Smith"></div>
		<div class="profile-info">
			<table>
				<tbody>
					<tr><td>Name</td><td>Alberto Escalante.</td></tr>
					<tr><td>Profession</td><td>Full Stack Developer</td></tr>
          <tr><td>Email</td><td>alhiky.es526@gmail.com</td></tr>
					<tr><td>Address</td><td>1610 N Central Ave, Tyler TX-75702</td></tr>
					<tr><td>Resume</td><td><a href="resume/2023.pdf" download>Download Resume</a></td></tr>
					<tr><td>Portfolio</td><td><a href="https://da-mongxiang.github.io/purple-dream2/" target="_blank">View Now</a></td></tr>
					<tr>
            <td>Contact</td>
            <td>
              <a href="https://github.com/Da-MongXiang" target="_blank"><i class="fab fa-github"></i></a>
            </td>
          </tr>
				</tbody>
			</table>
  ...
  },
  {
    ...
    html: `
			<div class="finland-map-wrap">
				<img class="finland-map" src="${imagePath}/us-map.svg" alt="US Map">
  ...
  },
  {
    ...
    width: 240,
    html: `<div class="profile-image"><img src="${imagePath}/friend.png" width="100%" alt="Tom"></div>
		<div class="profile-info">
			<table>
				<tbody>
					<tr><td>Name</td><td>Grayson Steele</td></tr>
					<tr><td>Alias</td><td>Gray</td></tr>
  ...
  },
  {
    ...
    html: `
			<table>
				<tbody>
					<tr><td>Boston Consulting Group, MA</a></td><td>Contract</td><td>2014 - 2016</td><td><a href="#" on</tr>
					<tr><td>protiviti,Inc</a></td><td>Full Time</td><td>2016 - 2020</td></tr>
					<tr><td>E-Logic,Inc</td><td>Contract</td><td>2020 - 2024</td><td></tr>
				</tbody>
			</table>
		`,
  },
  ...
  },
  {
    ...
    html: `<table>
        ...
        <tr><td>JavaScript</td><td>Go</td></tr>
				...
				<tr><td>Python</td><td>Kotlin</td></tr>
				<tr><td>C/C++</td><td>Java</td></tr>
				<tr><td>SQL/NoSQL</td><td>Dart</td></tr>
			</tbody>
		</table>`,
  },
  {
...
if (window.location.pathname !== "/") {
  new Terminal({
    ...
    commands: [
      {
        text: 'load profile -firstName "Alberto" -lastName "Escalante"',
        typing: true,
      },
      {
        text: "loading...",
